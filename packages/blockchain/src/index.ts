...
export default class Blockchain implements BlockchainInterface {
  ...
  private _genesis?: Buffer // the genesis block hash of this blockchain
  private _genesisBlock?: Block // the genesis block of this blockchain
  private _customGenesisState?: GenesisState
  ...
  private async _init(genesisBlock?: Block): Promise<void> {
    ...
    if (!genesisBlock) {
      const stateRoot = await genesisStateRoot(this.genesisState())
